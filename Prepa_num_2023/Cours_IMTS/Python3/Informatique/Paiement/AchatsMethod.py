def openfilleAchatsMethod():
    ...
    def afficher_produits(magasin):
        ...
        if magasin == "Magasin Vert":
            ...
            print("2. Produits laitiers - 45.80")
            print("3. Viandes et poissons - 35.36")
        elif magasin == "Carrefour Drive":
            print("1. Produits d'épicerie - 55.75")
            print("2. Produits d'hygiène - 45.96")
            print("3. Produits pour bébé - 25.78")
        elif magasin == "Auchan Drive":
            print("1. Produits surgelés - 35.95")
            print("2. Boissons - 15.76")
            print("3. Produits ménagers - 45.85")
        elif magasin == "Brico Dépôt":
            print("1. Matériel de construction - 235.096")
            print("2. Revêtements - 123.458")
            print("3. Rangement - 96.87")
        elif magasin == "FNAC":
            print("1. Livres - 12.75")
            print("2. High-tech - 23.98")
            print("3. Musique - 11.09")
        elif magasin == "Cultura":
            print("1. Loisirs créatifs - 10.34")
            print("2. Jeux de société - 5.86")
            print("3. Instruments de musique - 7.76")
        elif magasin == "Intermarché Drive":
            print("1. Produits d'épicerie - 12.87")
            print("2. Produits frais - 17.88")
            print("3. Produits d'hygiène - 55.33")
        elif magasin == "Super U Drive":
            print("1. Produits bio - 35.44")
            print("2. Produits locaux - 33.45")
            print("3. Produits pour animaux - 11.76")
        elif magasin == "Système U":
            print("1. Produits alimentaires - 45.44")
            print("2. Produits d'entretien - 56.88")
            print("3. Produits de beauté - 54.44")
        elif magasin == "Hyper U":
            print("1. Électroménager - 22.55")
            print("2. Vêtements - 29.88")
            print("3. Jouets - 21.98")
        elif magasin == "Lidl":
